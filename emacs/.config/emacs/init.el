...
(custom-set-variables
 ...
 '(package-selected-packages
	 '(terraform-mode treemacs-projectile treemacs-evil treemacs consult projectile go-mode lsp-ui lsp-haskell awesome-tray org-pomodoro treesit-auto org-roam-ui all-the-icons doom-modeline general org-roam lsp-mode rustic flycheck company kaolin-themes evil)))
(custom-set-faces
